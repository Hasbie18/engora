        ...
        <div className='w-full py-[5rem] px-4 bg-[#f1f1f1]'>
            ...
            <div className='max-w-[860px] mx-auto grid md:grid-cols-2 gap-8 py-4'>
                <div className='w-full shadow-xl flex flex-col p-4 my-2 rounded-lg hover:scale-105 duration-300'>
                    <FontAwesomeIcon icon={faUser} className='text-7xl'></FontAwesomeIcon>
                    <h2 className='text-2xl font-bold text-center py-5'>David Anderson</h2>
                ...
                <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                    <FontAwesomeIcon icon={faUser} className='text-7xl'></FontAwesomeIcon>
                    <h2 className='text-2xl font-bold text-center py-5'>Tom Milnes</h2>
                    <div className='text-center font-medium'>
                        <p className='py-2 border-b mx-8'>
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Itaque consequatur non molestiae distinctio dolore, ad vitae quas quis beatae necessitatibus animi deserunt aut cum voluptate.
                        </p>
                    </div>
                    <div className="flex flex-row mx-auto">
                        <button className='bg-[#00df9a] w-[50px] rounded-full mx-5 my-6 py-3 hover:bg-[#60a18d] '>
                ...
                <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                    <FontAwesomeIcon icon={faUser} className='text-7xl'></FontAwesomeIcon>
                    <h2 className='text-2xl font-bold text-center py-5'>Ian McKay</h2>
                    <div className='text-center font-medium'>
                ...
                <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                    <FontAwesomeIcon icon={faUser} className='text-7xl'></FontAwesomeIcon>
                    <h2 className='text-2xl font-bold text-center py-5'>Eliza Mahoney</h2>
                    <div className='text-center font-medium'>
